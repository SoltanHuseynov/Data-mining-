...
BreakWords <- read_excel("./breakwords.xlsx")
...
write_xlsx(Rdata,"./REDDIT/Redditlexcion.csv")
...
R_lexcion <-read_xlsx("./REDDIT/Redditlexcion.csv")
...
write_xlsx(Ydata,"./YOUTUBE/YoutubeLexcoin.csv")
...
#yorumlarini alalım
yt_lexcion <-read_xlsx("./YOUTUBE/YoutubeLexcoin.csv")
...
file1 <- file2 <- file3 <-loadWorkbook("./RedditAndYoutube.xlsx")
...
redditAndyoutube <-read_xlsx("./RedditAndYoutube.xlsx")
