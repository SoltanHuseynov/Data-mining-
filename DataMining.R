...
BreakWords <- read_excel("Data-mining--master/breakwords.xlsx")
...
write_xlsx(Rdata,"Data-mining--master/REDDIT/Redditlexcion.csv")
...
R_lexcion <-read_xlsx("Data-mining--master/REDDIT/Redditlexcion.csv")
...
write_xlsx(Ydata,"Data-mining--master/YOUTUBE/YoutubeLexcoin.csv")
...
#yorumlarini alalım
yt_lexcion <-read_xlsx("Data-mining--master/YOUTUBE/YoutubeLexcoin.csv")
...
file1 <- file2 <- file3 <-loadWorkbook("Data-mining--master/RedditAndYoutube.xlsx")
...
saveWorkbook(file1,"Data-mining--master/RedditAndYoutube.xlsx",overwrite = T)
saveWorkbook(file2,"Data-mining--master/RedditAndYoutube.xlsx",overwrite = T)
saveWorkbook(file3,"Data-mining--master/RedditAndYoutube.xlsx",overwrite = T)

# en sonda duygu analiz 
redditAndyoutube <-read_xlsx("Data-mining--master/RedditAndYoutube.xlsx")
